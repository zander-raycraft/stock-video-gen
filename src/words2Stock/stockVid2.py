...
def download_videos(keywords, per_page=50):  # Increased per_page to 50
    video_paths = []
            ...
            while checks_remaining > 0:
                ...
                if width == (height / 9) * 16:
                    ...
                    if r.status_code == 200:
                        ...
                        # Check and adjust framerate if necessary
                        video_path = adjust_framerate(video_path)
                        
                        video_paths.append(video_path)
                        videos_found = True
                        break  # Stop checking if a suitable video is found
                    else:
